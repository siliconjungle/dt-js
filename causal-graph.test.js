...
describe('doesDominate', () => {
  test('simple case', () => {
    ...
    expect(causalGraph.doesDominate(cg, [index2], index)).toBe(true)
  })
  test('complex case', () => {
    const cg = causalGraph.create()
    ...
    expect(causalGraph.doesDominate(cg, [i3], i1)).toBe(true)
    expect(causalGraph.doesDominate(cg, [i3], i2)).toBe(true)
    expect(causalGraph.doesDominate(cg, [i2], i1)).toBe(false)

    expect(causalGraph.doesDominate(cg, [i0], i1)).toBe(false)
    expect(causalGraph.doesDominate(cg, [i0], i2)).toBe(false)
    expect(causalGraph.doesDominate(cg, [i0], i3)).toBe(false)
    expect(causalGraph.doesDominate(cg, [i0], i4)).toBe(false)

    expect(causalGraph.doesDominate(cg, [i4], i0)).toBe(true)
    expect(causalGraph.doesDominate(cg, [i4], i1)).toBe(true)
    expect(causalGraph.doesDominate(cg, [i4], i2)).toBe(true)
    expect(causalGraph.doesDominate(cg, [i4], i3)).toBe(true)
  })
})
